...
class PostControllerSpec extends Specification {
	...
	@spock.lang.Unroll
	def "Testing id of #suppliedId redirects to #expectedUrl and #flashMessage error"() {
		...
		when: "addPost is invoked with a login ID but no post content"
		def model = controller.addPost(suppliedId, null)
		...
		where:
		suppliedId  |   expectedUrl               |  flashMessage
		'joe_cool'  |   '/users/joe_cool'         |  'Invalid or empty post'
		'sara'      |   '/users/sara'             |  'Invalid or empty post'
		null        |   '/users'                  |  'Invalid or empty post'
